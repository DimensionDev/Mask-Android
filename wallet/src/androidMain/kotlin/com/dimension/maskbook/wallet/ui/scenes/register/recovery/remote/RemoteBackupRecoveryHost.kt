...
@NavGraphDestination(
    route = WalletRoute.Register.Recovery.RemoteBackupRecovery.RemoteBackupRecovery_NoBackup,
...
@NavGraphDestination(
    route = WalletRoute.Register.Recovery.RemoteBackupRecovery.RemoteBackupRecovery_Email,
    packageName = navigationComposeBottomSheetPackage,
    functionName = navigationComposeBottomSheet,
)
@Composable
...
@NavGraphDestination(
    route = WalletRoute.Register.Recovery.RemoteBackupRecovery.RemoteBackupRecovery_Phone_Code.path,
    packageName = navigationComposeBottomSheetPackage,
    functionName = navigationComposeBottomSheet,
)
@Composable
...
@NavGraphDestination(
    route = WalletRoute.Register.Recovery.RemoteBackupRecovery.RemoteBackupRecovery_Phone,
    packageName = navigationComposeBottomSheetPackage,
    functionName = navigationComposeBottomSheet,
)
@Composable
